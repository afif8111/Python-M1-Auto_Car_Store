                ...
                if car_id.isdigit(): # Check if input is a valid integer
                    ...
                    if option == 'buy':
                        if car_id in car_store:
                            ...
                            car_store = {idx: car for idx, car in enumerate(car_store.values(), start=1)}#To auto reindex after the car is removed
                            return
                        else:
                        ...
                        if car_id in car_rent:
                            ...
                            car_rent = {idx: car for idx, car in enumerate(car_rent.values(), start=1)}#To auto reindex after the car is removed
                            return
                        else:
